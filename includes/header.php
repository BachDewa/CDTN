  ...
  <div class="bg-nav bg-cover bg-center">
    ...
    <header class=" text-white py-20">
      <div class="container mx-auto text-center">
        <h1 class="text-4xl font-bold">Chào mừng bạn đến với Cô gái tóc mây</h1>
        <p class="mt-4 text-lg">Làm mới và nâng tầm vẻ đẹp của bạn với sản phẩm của chúng tôi</p>
        <!-- <a href="../cuahang.php" class="mt-6 inline-block bg-blue-500 text-white py-2 px-4 rounded">Xem ngay</a> -->
      </div>
    </header>
  </div>
